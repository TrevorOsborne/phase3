...
class CardGameFramework
{
   ...
   CardGameFramework(int numPacks, int numJokersPerPack, int numUnusedCardsPerPack, Card[] unusedCardsPerPack,
...
class GUICards
{
   ...
   /**
    * turnIntIntoCardRank - turns 0 .. 13 into "A", "2", "3", ... "Q", "K", "X"
    * 
    * @param k
    *           - int to convert
...
class Card
{
    ...
    * 
    * @param originalCard
    *           - values to be copied into new separate Card object
    */
    ...
    *
    * @return String - concatenated value and suit of Card object
    */
   @Override
   ...
   /**
    * Public Mutator Method for value and cardSuit for legal parameters, sets
    ...
    * @param card
    *           - card to be compared
    * @return boolean - true if all suit, value and errorFlag fields equal card
   ...
   /**
    * Private helper method to determine validity of checkValue argument. Suit is
    * currently an enum and not checked by this method.
    * 
    * @param value
...
class Hand
{
   ...
   /*
    * Resets the array by developing a new one. The previous array will eventually
    * be removed.
    */
   ...
   /*
    * We add a card as input and put it to the front of the array. If the card is
    * not added it returns false otherwise it is true.
    */
   ...
   /*
    * Returns the card at k in the array MyCard. If k happens to be invalid then a
    * invalid card will be created and returned.
    */
   ...
   /*
    * Sorts hand by calling arraySort() method in Card Class.
    */
   public void sort()
   {
...
/**
 * A Deck object is the source of all cards. It's where the dealer gets cards to
 * deal, and if a player takes an individual card after the deal, he takes it
...
class Deck
{
   ...
   /**
    * Constructor for Deck if numPacks exceed max packs of 6, sets to 6 if True
    * 
    * @param numPacks
    *           - total packs of cards to include in Deck
    */
   ...
   /**
    * Restocks the deck to the original full condition in preparation for a fresh
    * deal
    * 
    * @param numPacks
    *           - how many packs the original created deck object contained
    */
   ...
   /**
    * Mixes up the cards with the help of a standard random number generator
    */
   public void shuffle()
   {
    ...
    * 
    * @return - Removes top Card from deck object and deals to player
    */
    ...
    * Public accessor method
    *
    * @return - Returns the index to the card on top of a deck object
    */
   ...
   /*
    * Accessor for an individual card returns a card with errorFlag set to true if
    * k is bad
    *
   ...
   /*
    * Sets each card in masterDeck[] starting with aces and so on
    */
   private static void allocateMasterPack()
   {
      ...
      for (int cardValue = 1; cardValue < totalTypeCards + 1; cardValue++)
      {
         for (int cardSuit = 0; cardSuit < suits.length; cardSuit++)
         {
            ...
            {
               masterPack[masterIndex++] = new Card((char) (cardValue + 48), suits[cardSuit]);
               continue;
            } else if (cardValue == 1)
            {
   ...
   /**
    * Calls Card's sort() to put cards in deck into order according to their values
    */
   public void sort()
   {
